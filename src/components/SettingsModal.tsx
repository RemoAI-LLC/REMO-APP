...
import { IoClose, IoCog, IoDesktop, IoLink, IoPerson, IoColorPalette, IoShield, IoCheckmark, IoChevronForward } from "react-icons/io5";
...
type SettingsTab = "general" | "integrations" | "account" | "appearance" | "privacy";
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Connect your Gmail account for email features</p>
                </div>
              </div>
